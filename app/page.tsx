    ...
    <main className="min-h-screen bg-gradient-to-br from-sky-100 via-white to-cyan-100 flex items-center justify-center p-6">
      <div className="max-w-4xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center p-8">
          ...
          >
            <div
              className="w-80 h-80 rounded-full border-8 border-sky-500 shadow-xl bg-cover bg-center"
              style={{
          ...
          >
            ...
            <button
              className="mt-8 px-8 py-4 bg-sky-600 hover:bg-sky-700 transition-all text-white rounded-xl text-lg font-semibold shadow-lg"
            >
              شروع آموزش
            </button>
          </motion.div>
